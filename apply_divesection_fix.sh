      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div>
          ...
          <input
            type="number"
            name="maxDepth"
            value={form.maxDepth === 0 ? "" : form.maxDepth}
            onChange={onChange}
        ...
        <div>
          ...
          <input
            type="number"
            name="averageDepth"
            value={form.averageDepth === 0 ? "" : form.averageDepth}
            onChange={onChange}
            className="w-full rounded-lg border border-slate-700 bg-slate-800 p-3"
          />
        </div>
        ...
        <div>
          ...
          <input
            type="number"
            name="safetyStop"
            value={form.safetyStop === 0 ? "" : form.safetyStop}
            onChange={onChange}
            className="w-full rounded-lg border border-slate-700 bg-slate-800 p-3"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            value={
              form.waterTemperature === 0
                ? ""
                : form.waterTemperature
            }
            onChange={onChange}
            className="w-full rounded-lg border border-slate-700 bg-slate-800 p-3"
          />
        ...
        <div>
          ...
          <input
            type="number"
            name="visibility"
            value={form.visibility === 0 ? "" : form.visibility}
            onChange={onChange}
            className="w-full rounded-lg border border-slate-700 bg-slate-800 p-3"
          />
        </div>
