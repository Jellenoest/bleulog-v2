...
cat > components/dives/DiveSiteSearch.tsx <<'EOF'
"use client";
...
cat > components/maps/LocationPicker.tsx <<'EOF'
"use client";
...
echo
echo "KLAAR. De juiste actieve componenten zijn aangepast."
echo
echo "Nu pushen met:"
echo "git add components/dives/DiveSiteSearch.tsx components/maps/LocationPicker.tsx"
echo "git commit -m 'Fix dive site dropdown and GPS picker'"
echo "git push"
